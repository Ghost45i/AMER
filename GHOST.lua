...
if hash or SudoBot(msg) or DevGHOSTW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevGHOSTW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevGHOSTW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevGHOSTW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevGHOSTW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevGHOSTW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevGHOSTW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local GHOST_Msg = ''  
if msgs < 100 then 
GHOST_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
GHOST_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
GHOST_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
GHOST_Msg = 'متفاعل' 
elseif msgs < 1200 then 
GHOST_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
GHOST_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
GHOST_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
GHOST_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
GHOST_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
GHOST_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
GHOST_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
GHOST_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
GHOST_Msg = 'رب التفاعل'  
end 
return GHOST_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceGHOST(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if DevGHOSTW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,GHOST_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ☬' and DevGHOSTW(msg) then  
...
if text == 'تعطيل التواصل ☬' and DevGHOSTW(msg) then  
...
if text == 'تفعيل البوت الخدمي ☬' and DevGHOSTW(msg) then  
...
if text == 'تعطيل البوت الخدمي ☬' and DevGHOSTW(msg) then  
...
if text == 'ضع كليشه ستارت ☬' and DevGHOSTW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *☬⇠ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ☬' and DevGHOSTW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *☬⇠تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ☬' and DevGHOSTW(msg) then 
...
if text == 'تحديث السورس ☬' and DevGHOSTW(msg) then 
...
if text == 'المشتركين ☬' and DevGHOSTW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *☬⇠المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ☬' and DevGHOSTW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *☬⇠الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ☬") and DevGHOSTW(msg) then
...
if text == ("قائمه العام ☬") and DevGHOSTW(msg) then
...
if text == ("قائمه الكتم العام ☬") and DevGHOSTW(msg) then
...
if text=="اذاعه خاص ☬" and msg.reply_to_message_id_ == 0 and DevGHOSTW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *☬⇠ارسل الان اذاعتك؟* \n*☬⇠للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ☬" and msg.reply_to_message_id_ == 0 and DevGHOSTW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *☬⇠ارسل الان اذاعتك؟* \n*☬⇠للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ☬" and msg.reply_to_message_id_ == 0 and DevGHOSTW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *☬⇠ارسل الان اذاعتك؟* \n*☬⇠للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ☬" and msg.reply_to_message_id_ == 0  and DevGHOSTW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *☬⇠ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ☬" and msg.reply_to_message_id_ == 0  and DevGHOSTW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☬⇠ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ☬' and DevGHOSTW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ☬" and DevGHOSTW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ☬" and DevGHOSTW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*☬⇠عدد الكروبات الان » { '..#group..' }'..GHOSTk..''..GHOST..'*\n*☬⇠الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevGHOSTW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevGHOSTW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevGHOSTW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevGHOSTW(msg) then
...
local GHOST1_Msg = database:get(bot_id.."GHOST1:Add:Filter:Rp2"..text..msg.chat_id_)   
if GHOST1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if GHOST_Msg and not Special(msg) then  
local GHOST_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if GHOST_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevGHOSTW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevGHOSTW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevGHOSTW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *☬⇠حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevGHOSTW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *☬⇠حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ☬" and DevGHOSTW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *☬⇠تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ☬$") and DevGHOSTW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *☬⇠حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ☬" and DevGHOSTW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ☬" and DevGHOSTW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *☬⇠تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ☬" and DevGHOSTW(msg) then  
...
database:sadd(bot_id.."GHOST:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."GHOST:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_GHOST = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_GHOST then 
names_GHOST = database:smembers(bot_id.."GHOST:blocname"..msg.chat_id_) or ""
if names_GHOST and names_GHOST[1] then 
for i=1,#names_GHOST do 
if name_GHOST:match("(.*)("..names_GHOST[i]..")(.*)") then 
...
database:set(bot_id.."GHOST:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."GHOST:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."GHOST:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."GHOST:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."GHOST:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_GHOSTa_new(GHOST1,GHOST2)
if GHOST2 and GHOST2.first_name_ then 
if GHOST2.first_name_:match("(.*)"..database:get(bot_id.."GHOST:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."GHOST:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local GHOST_nnn = database:get(bot_id.."GHOST:nump"..msg.chat_id_) or 5
local GHOST_nnn2 = database:get(bot_id.."GHOST:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(GHOST_nnn2) == tonumber(GHOST_nnn) or tonumber(GHOST_nnn2) > tonumber(GHOST_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."GHOST:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☬⇠عزيزي >>["..GHOST2.username_.."](https://t.me/"..(GHOST2.username_ or "cssss2")..")\n☬⇠عليك وضع التوحيد ⪼ {"..database:get(bot_id.."GHOST:teh"..msg.chat_id_).."} بجانب اسمك\n☬⇠عدد المحاولات المتبقيه {"..(tonumber(GHOST_nnn) - tonumber(GHOST_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_GHOSTa_new)
end
end
...
local GHOSTChengName = database:get(bot_id.."GHOST:Cheng:Name"..data.id_)
if not data.first_name_ then 
if GHOSTChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..GHOSTChengName..']')
database:del(bot_id.."GHOST:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if GHOSTChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."GHOST:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local GHOSTChengUserName = database:get(bot_id.."GHOST:Cheng:UserName"..data.id_)
if not data.username_ then 
if GHOSTChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..GHOSTChengUserName..']')
database:del(bot_id.."GHOST:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if GHOSTChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."GHOST:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local GHOSTChengPhoto = database:get(bot_id.."GHOST:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if GHOSTChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."GHOST:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if GHOSTChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."GHOST:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevGHOSTW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevGHOSTW(msg) then
dofile('GHOST.lua')  
send(msg.chat_id_, msg.id_, ' *☬⇠تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevGHOSTW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevGHOSTW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if GHOSTSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevGHOSTW(msg) then
...
if GHOSTSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*☬⇠لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevGHOSTW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevGHOSTW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevGHOSTW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevGHOSTW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevGHOSTW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevGHOSTW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevGHOSTW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevGHOSTW(msg) then
...
if text == 'الملفات' and DevGHOSTW(msg) then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevGHOSTW(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevGHOSTW(msg) then
...
if text == "مسح الملفات" and DevGHOSTW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *☬⇠تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevGHOSTW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevGHOSTW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_GHOST(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_GHOST, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_GHOST, nil)
return false 
end
...
database:set(bot_id.."GHOST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."GHOST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *☬⇠ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."GHOST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."GHOST1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."GHOST1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."GHOST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *☬⇠تم منع الكلمه مع التحذير*")  
database:del(bot_id.."GHOST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."GHOST1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."GHOST1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."GHOST1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *☬⇠ارسل الكلمه الان*")  
database:set(bot_id.."GHOST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."GHOST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."GHOST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."GHOST1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."GHOST1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."GHOST1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."GHOST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."GHOST1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."GHOST1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *☬⇠قائمة المنع* \n*•━━━━━━ G𝐓 ━━━━━━━•*\n"
for k,v in pairs(list) do  
local GHOST_Msg = database:get(bot_id.."GHOST1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..GHOST_Msg.."}\n"
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevGHOSTW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *☬⇠تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevGHOSTW(msg) then
...
if text == 'تفعيل الاذاعه' and DevGHOSTW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevGHOSTW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..GHOST_Msg[math.random(#GHOST_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevGHOSTW(msg) then 
...
if GHOSTSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevGHOSTW(msg) then 
...
if text == ("ردود المطور") and DevGHOSTW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ☬⇠قائمة ردود المطور \n*•━━━━━━ G𝐓 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevGHOSTW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevGHOSTW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevGHOSTW(msg) then   
...
if text == 'تعطيل المغادره' and DevGHOSTW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*☬⇠العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'GHOST')..') '
...
-- vardump(data) 
GHOSTdx(msg.chat_id_, msg.id_, ' *☬⇠ايدي المجموعة » ( '..msg.chat_id_..' )*\n*☬⇠عدد الادمنيه » ( '..data.administrator_count_..' )*\n*☬⇠عدد المحظورين » ( '..data.kicked_count_..' )*\n*☬⇠عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevGHOSTW(msg) then
...
GHOST = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(GHOST)
...
--------------------------------------------------------------------------------------------------------------
SourceGHOST(data.message_,data)
...
------------------------------------------------------------------------
local GHOSTAbot = database:get(bot_id.."GHOST1:Add:Filter:Rp2"..text..result.chat_id_)   
if GHOSTAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *☬⇠العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n☬⇠["..GHOSTAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local GHOST1_Msg = database:get(bot_id.."GHOST1:Add:Filter:Rp2"..text..result.chat_id_)   
if GHOST1_Msg then
send(msg.chat_id_, msg.id_," ☬⇠"..GHOST1_Msg)
