...
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'مطور ثاني'  
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
var = database:get(bot_id.."BasicConstructor:Rd"..msg.chat_id_) or 'المنشئ اساسي'
elseif database:sismember(bot_id..'Biasic:Constructor'..chat_id, user_id) then
var = database:get(bot_id.."BiasicConstructor:Rd"..msg.chat_id_) or 'مساعد مالك'
elseif database:sismember(bot_id..'Constructor'..chat_id, user_id) then
...
usertext = '\n ✸∫ العضــو » ['..result.title_..'](t.me/'..(username or 'BOBBW')..')'
status  = '\n ✸∫ تم ترقيته مطور'
...
usertext = '\n✸∫ العضو » ['..result.title_..'](t.me/'..(username or 'FEEEM')..')'
...
if text == ("رفع مطور ثاني") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور ثاني @(.*)$") and Sudo(msg) then
...
usertext = '\n  ✸∫ العضــو » ['..result.title_..'](t.me/'..(username or 'FEEEM')..')'
status  = '\n ✸∫ تم رفعه مطور ثاني'
texts = usertext..status
else
texts = '✸∫ لا يوجد حساب بهاذا المعرف'
...
if text and text:match("^رفع مطور ثاني (%d+)$") and Sudo(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n  ✸∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'FEEEM')..')'
status  = '\n ✸∫ تم رفعه مطور ثاني'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n  ✸∫ العضــو » '..userid..''
...
if text == ("تنزيل مطور ثاني") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مطور ثاني @(.*)$") and Sudo(msg) then
...
if text and text:match("^تنزيل مطور ثاني (%d+)$") and Sudo(msg) then
...
if text == ("مسح المساعدين") and BasicConstructor(msg) then
database:del(bot_id..'Biasic:Constructor'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n✸∫ تم مسح قائمه مساعد مالك')
return false
end

if text == 'قائمه المساعدين' and BasicConstructor(msg) then
...
if #list == 0 then
t = "✸∫ لا يوجد مساعدين مالك"
end
send(msg.chat_id_, msg.id_, t)
return false
end

if text == ("رفع مساعد مالك") and msg.reply_to_message_id_ and BasicConstructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مساعد مالك @(.*)$") and BasicConstructor(msg) then
local username = text:match("^رفع مساعد مالك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مساعد مالك (%d+)$") and BasicConstructor(msg) then
local userid = text:match("^رفع مساعد مالك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل مساعد مالك") and msg.reply_to_message_id_ and BasicConstructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مساعد مالك @(.*)$") and BasicConstructor(msg) then
local username = text:match("^تنزيل مساعد مالك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مساعد مالك (%d+)$") and BasicConstructor(msg) then
local userid = text:match("^تنزيل مساعد مالك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✸∫ العضــو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BOBBW')..') \n ✸∫ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✸∫ العضــو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✸∫ ["..BOYKA_Msg.."] \n")
else
send(msg.chat_id_,0," ✸∫ العضــو : {["..data.first_name_.."](T.ME/BOBBW)}\n ✸∫ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✸∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BOBBW')..')'
status  = '\n ✸∫ تم تنزيل العضــو مطي في الكروب\n ✸∫ تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✸∫ العضــو » ['..result.title_..'](t.me/'..(text1[3] or 'BOBBW')..')'..'\n ✸∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'*- العضــو » (*'..username..'*)\n- الرتبه » ('..rtp..')*\n')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if text and text:match("^تغير رد العضــو (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد العضــو (.*)$") 
database:set(bot_id.."Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," ✸∫ تم تغير رد العضــو الى » "..Teext)
end
